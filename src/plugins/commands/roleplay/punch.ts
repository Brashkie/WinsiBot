...
const BASE  = 'https://raw.githubusercontent.com/Brashkie/module/main/download/anime/vid/role/punch'
const TOTAL = 44

const command: Command = {
  name: 'punch',
  aliases: ['golpear', 'puñetazo', 'puñete'],
  ...
  async execute({ sock, jid, msg, sender, pushName }) {
    ...
    const caption = isSelf
      ? `${me} se golpeó a sí mismo`
      : `${me} le dio un puñetazo a ${target.display}`
