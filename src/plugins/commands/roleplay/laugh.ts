...
const BASE  = 'https://raw.githubusercontent.com/Brashkie/module/main/download/anime/vid/role/laugh'
const TOTAL = 30

const command: Command = {
  name: 'laugh',
  aliases: ['reir', 'jaja', 'lol'],
  description: 'Ríe (o se ríe de alguien)',
  category: 'roleplay',
  cooldown: 5,
