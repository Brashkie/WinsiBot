...
const BASE  = 'https://raw.githubusercontent.com/Brashkie/module/main/download/anime/vid/role/sad'
const TOTAL = 48

const command: Command = {
  name: 'sad',
  aliases: ['triste'],
  description: 'Muestra tristeza (o pone triste a alguien)',
  category: 'roleplay',
  cooldown: 5,
  ...
  async execute({ sock, jid, msg, sender, pushName }) {
    ...
    const caption = isSelf
      ? `${me} está triste 😔`
      : `${me} puso triste a ${target.display} 😔`
